...
export async function resolveUosSourceRecord({
  ...
  return requestJson('source-record-links/resolve', {
    ...options,
    query: {
    ...
    cacheKey: `source-record-${sourceDocumentId}-${sourceTab}-${sourceRecordKey}`
  });
}
