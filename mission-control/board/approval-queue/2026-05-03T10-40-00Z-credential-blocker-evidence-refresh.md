# Credential Blocker Evidence Refresh — 2026-05-03 10:40 UTC
...
1. `bash scripts/pipeline-run-credential-env-check.sh`
   - Output: `mission-control/evidence/pipeline-run/2026-05-03T10-40-00Z-credential-env-check.md`
2. `bash scripts/pipeline-run-credential-preflight.sh`
   - Output: `mission-control/evidence/pipeline-run/preflight-2026-05-03T10-40-27Z.md`
