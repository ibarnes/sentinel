...
Owner: sentinel
Parent: TASK-0107
Child Task: TASK-0402
Input Report: mission-control/artifacts/2026-06-09-stale-rfr-parent-report.json
...
## Summary
- stale Ready for Review rows scanned: 151
...
## Hold Cases
Do not backfill these rows from heuristics alone. Each one needs an explicit lineage choice or a narrower companion artifact first.
...
| TASK-0313 | BRS-2026-05-06 Build stale-RFR tranche-AK compaction + decision template artifact | none | Multiple plausible parent streams or no lineage evidence. | Keep on manual hold until a dedicated routing/decision artifact names the canonical parent. |
...
| TASK-0382 | BRS-2026-06-06g Add unified recovery apply-preview script | TASK-0107, TASK-0269, TASK-0335, TASK-0379 | Multiple plausible parent streams or no lineage evidence. | Keep on manual hold until a dedicated routing/decision artifact names the canonical parent. |
| TASK-0383 | BRS-2026-06-06h Publish live apply-preview card for unified recovery packet | TASK-0107, TASK-0269, TASK-0382 | Multiple plausible parent streams or no lineage evidence. | Keep on manual hold until a dedicated routing/decision artifact names the canonical parent. |
| TASK-0384 | BRS-2026-06-07a Add guarded unified recovery apply engine | TASK-0107, TASK-0269, TASK-0335, TASK-0379 | Multiple plausible parent streams or no lineage evidence. | Keep on manual hold until a dedicated routing/decision artifact names the canonical parent. |
| TASK-0385 | BRS-2026-06-07b Publish blocked apply receipt for current unified recovery packet | TASK-0107, TASK-0269, TASK-0384 | Multiple plausible parent streams or no lineage evidence. | Keep on manual hold until a dedicated routing/decision artifact names the canonical parent. |
...
2. Keep the unified recovery dual-parent artifacts (`TASK-0382` to `TASK-0385`) on hold unless Isaac chooses a single canonical parent stream for them.
