# Credentialed Smoke Operator Handoff Refresh (2026-06-10T10:40:00Z)

- Parent Stream: TASK-0103
- Subtask Candidate: TASK-0405
...
5. If a post-capture closeout pass is needed, run:
   - `bash scripts/pipeline-run-closeout.sh <evidence-dir>`
6. Confirm the evidence bundle contains:
   - auth-smoke.log
   - valid-response.json
