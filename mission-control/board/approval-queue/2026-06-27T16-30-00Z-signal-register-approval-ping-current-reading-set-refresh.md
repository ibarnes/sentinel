...
## Why this exists
- The 03:10 UTC send-ready ping was still correct, but it depended on a June 25 reply card even after June 26 and June 27 tightened the current execution contract.
- The honest midday move is to refresh that ping so the smallest current reading set is fully aligned to the live board-native packet and same-day decision block.
...
3. 2026-06-27T16-30-00Z-signal-register-current-owner-reply-block.md
