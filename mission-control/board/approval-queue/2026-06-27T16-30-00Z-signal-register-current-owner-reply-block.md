...
## Why this exists
- The current approval ping still points back to the June 25 reply card even though the live execution contract was tightened on June 26 and reconfirmed on June 27.
- The honest midday move is to publish one same-day reply block that maps directly to the current board-native packet and exact post-approval task sequence.
