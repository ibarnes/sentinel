...
## Why this exists
- The live Signal Register approval surface was tightened at `2026-07-05 16:30 UTC`.
- The honest night-window move is to prove that same-day surface still carries forward unchanged into the next build window before any new approval-routing work is invented.
...
- Re-read live `mission-control/board/BOARD.json` at `2026-07-06 03:10 UTC`.
- No new `TASK-0012` child rows appeared after `TASK-0534`.
- No approval tuple, hold branch, generator path, generated artifact path, output path, or stop-after-receipt rule changed between the July 5 `16:30 UTC` packet and this night window.
...
- Carry forward the July 5 `16:30 UTC` approval surface unchanged.
- Do not create replacement routing artifacts unless one of these changes first:
  ...
  - The exact generator, output, or receipt path contract changes.
