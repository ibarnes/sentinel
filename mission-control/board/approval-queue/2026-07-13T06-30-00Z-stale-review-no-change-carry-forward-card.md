# July 13 Stale Review No-Change Carry-Forward Card
Generated: 2026-07-13 06:30 UTC

## Live reread
- Re-read live `mission-control/board/BOARD.json` at sweep time.
- Truthful stalled open set at `2026-07-13T06:30:00Z`:
  - `0` `Doing >48h`
...
## Why the lane is unchanged
- The July 12 recovery sweep already re-expanded the truthful stale-review baseline from `11` back to `14` when `TASK-0029` and `TASK-0030` aged past the `24h` threshold again.
- No task in the stalled lane changed status or received a freshness update between `2026-07-12T06:30:00Z` and this sweep.
- `TASK-0107` and `TASK-0269` remain blocked parents and should continue to be tracked as blocked rather than counted as additional stale-review rows.
- The truthful July 13 surface is therefore unchanged: `14` stale review rows plus blocked parents `TASK-0107` / `TASK-0269`.
