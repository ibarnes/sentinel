...
Generated: 2026-06-29 06:30 UTC
...
- `TASK-0029`, `TASK-0030`, `TASK-0107`, and `TASK-0269` had each now sat unchanged for `96.0h`.
...
- Why this won:
  ...
  - the real change since the prior late-night recovery sweep is that the parent review/recovery asks have now crossed the next `96.0h` threshold
...
### Subtask executed
- `TASK-0501` - Publish stalled-bundle 96h refresh card for the live five-row lane
- Timebox: `30-45 min`
- Acceptance criteria:
  ...
  - Artifact records the `96.0h` threshold crossing for `TASK-0029`, `TASK-0030`, `TASK-0107`, and `TASK-0269` while keeping one exact default reply tuple plus replay/reopen alternates.
  - Board linkage points the live parent rows to the June 29 recovery surfaces.
