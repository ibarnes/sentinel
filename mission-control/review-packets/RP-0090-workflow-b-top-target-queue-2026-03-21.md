# RP-0090 — Workflow B Top Target Queue — 2026-03-21
...
- Warming-path recency SLA breaches remain active (>14 days):
  - NSIA `PATH-NSIA-001` (Warming, ~24.5d)
  - TAFF `PATH-TAFF-FAISAL-NET-001` (Warming, ~15.6d)
- Additional recency pressure remains on key ready lanes:
  - PIF `PATH-PIF-001` (~22.5d)
  - AFC `PATH-AFC-001` (~23.5d)
...
8. **AFC** — Priority 9
   - Why now: no DA coverage and path recency drift now >23 days.
...
10. **NSIA** — Priority 8
    - Why now: warming path now >24 days without progression.
