# RP-0095 — Workflow B Top Target Queue — 2026-03-22
...
- High-influence/no-path gaps remain active for top-ranked buyers:
  ...
  - DFC: Ben Black
  - DFC: Conor Coleman
- Warming/blocked recency SLA breaches remain active (>14 days):
  - NSIA `PATH-NSIA-001` (Warming, ~25.5d)
  - TAFF `PATH-TAFF-FAISAL-NET-001` (Warming, ~16.6d)
- Additional recency pressure remains on key ready/active lanes:
  - PIF `PATH-PIF-001` (~23.5d, Ready)
  - AFC `PATH-AFC-001` (~24.5d, Ready)
...
7. **PIF** — Priority 10 (Urgency 3 / Fit 2 / Staleness 5)
   - Why now: no DA coverage and path recency drift remains >22 days.
...
8. **AFC** — Priority 10 (Urgency 3 / Fit 2 / Staleness 5)
   - Why now: no DA coverage and path recency drift remains >23 days.
...
10. **NSIA** — Priority 10 (Urgency 3 / Fit 2 / Staleness 5)
   - Why now: warming path remains >25 days without progression.
