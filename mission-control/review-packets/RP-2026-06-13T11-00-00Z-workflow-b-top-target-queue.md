# Workflow B Top Target Queue - 2026-06-13
...
- Signal-pressure delta remained fresh from `2026-06-13T10:11:13.443Z` with `new_high_impact_count=0` and `new_signal_count=0`; durable signal overlap remains heaviest on Africa Finance Corporation, African Development Bank, International Finance Corporation, Public Investment Fund, Nigeria Sovereign Investment Authority, and Mubadala Investment Company.
...
1. **Public Investment Fund** - Priority 11 (Urgency 4 / Buyer Fit 2 / Staleness 5)
   - Why now: sovereign-capital pressure remains high and PIF still has only one thin ready-state path, but there is still no decision architecture and no durable dated access route.
...
3. **Africa Finance Corporation** - Priority 11 (Urgency 4 / Buyer Fit 2 / Staleness 5)
   - Why now: AFC carries the densest current signal overlap in the top queue and still has only one thin ready-state path, yet there is no decision architecture or dated execution route.
